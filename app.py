...
#app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:PASSWORD@localhost:5432/imgtxt_db
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://localhost/img2text_db'
